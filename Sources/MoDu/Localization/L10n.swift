...
enum L10n {
    enum Key: String, CaseIterable, Sendable {
        ...
        case settingsShortcutsTitle = "settings.shortcuts.title"
        case settingsShortcutHint = "settings.shortcuts.hint"
        case settingsShortcutRecording = "settings.shortcuts.recording"
        case settingsShortcutInvalid = "settings.shortcuts.invalid"
        case settingsShortcutConflict = "settings.shortcuts.conflict"
        case settingsShortcutReset = "settings.shortcuts.reset"
        case settingsShortcutSpace = "settings.shortcuts.space"
        case commandToggleSidebar = "command.toggleSidebar"
        case commandToggleOutline = "command.toggleOutline"
        case commandToggleSplitReading = "command.toggleSplitReading"
        case sidebarShow = "sidebar.show"
        case sidebarHide = "sidebar.hide"
        case sidebarResizeHelp = "sidebar.resizeHelp"
        case sidebarResizeAccessibility = "sidebar.resizeAccessibility"
        ...
        case sidebarRevealCurrentFile = "sidebar.revealCurrentFile"
